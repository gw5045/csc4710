...
public class ListingDAO 
{
    ...
    public Listing getListedNft(int nft) throws SQLException {
        ...
        String sql = "SELECT * FROM Listing WHERE nftid = " + "'" + nft + "'";      
        connect_func();    
    ...
    public void init() throws SQLException, FileNotFoundException, IOException{
        ...
        String[] TUPLES = {("insert into Listing(owner, nftid, start, end, price)" +
        		"values ('brent@gmail.com', '100', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('gon@gmail.com', '101', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('denji@gmail.com', '102', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('jo@gmail.com', '103', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('wallace@gmail.com', '104', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('megan@gmail.com', '105', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('nikolas@gmail.com', '106', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('franky@gmail.com', '107', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('kakyoin@gmail.com', '108', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('funny@gmail.com', '109', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10')," +
        				"('gon@gmail.com', '110', '"+ startTime.toString() + "','"+ endTime.toString()+ "', '10');" )};
